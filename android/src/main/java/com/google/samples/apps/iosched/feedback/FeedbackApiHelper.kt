 ...
 */
class FeedbackApiHelper(private val mHttpClient: BasicHttpClient, private val mUrl: String) {
     ...
     */
    fun sendSessionToServer(sessionId: String?, questions: HashMap<String, String>?): Boolean {
    ...
    companion object {
        ...
        private val TAG = makeLogTag(FeedbackApiHelper::class.java)
    }
