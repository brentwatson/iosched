...
/**
 * A simple [BroadcastReceiver] that triggers a sync. This is used by the GCM code to trigger
 * jittered syncs using [android.app.AlarmManager].
 */
class TriggerSyncReceiver : BroadcastReceiver() {

    override fun onReceive(context: Context, intent: Intent) {
        val accountName = AccountUtils.getActiveAccountName(context)
    ...
    companion object {
        val EXTRA_USER_DATA_SYNC_ONLY = "com.google.samples.apps.iosched.EXTRA_USER_DATA_SYNC_ONLY"
    }
}
