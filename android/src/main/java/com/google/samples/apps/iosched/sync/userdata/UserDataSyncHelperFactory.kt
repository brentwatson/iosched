 ...
 */
object UserDataSyncHelperFactory {
    fun buildSyncHelper(context: Context, accountName: String): AbstractUserDataSyncHelper {
        return GMSUserDataSyncHelper(context, accountName)
    }
}